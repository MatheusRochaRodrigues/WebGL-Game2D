...
public class Animal : MonoBehaviour, ILife
{
    public float moveSpeed = 2f; // Velocidade normal
    public float fleeSpeed = 4f; // Velocidade ao fugir
    ...
    public float fleeDuration = 2f; // Tempo de fuga
    ...
    private bool isFleeing = false; // Se está fugindo
